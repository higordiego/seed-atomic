...
const template = hbs.compile(
	...
	<title>Set up a new password for Seed-Mean</title>
	<!-- 
	...
	*:not(br):not(tr):not(html) {
	...
	<tr>
	<td>
	<a href="http://127.0.0.1:8080/#!/new/{{forgot}}" class="button button--green" target="_blank">Reset your password</a>
	</td>
	</tr>
	</table>
	</td>
	...
	<p class="sub align-center">&copy; 2017 Seed-Mean. All rights reserved.</p>
